...
// 最后的__res 是其输出值
// :"0" (seg),  表示在这段代码运行前，将 seg 放到 eax 寄存器中
...
/* set_trap_gate()与 set_system_gate()的主要区别在于前者设置
   的特权级为 0，后者是 3。着两个函数是宏定义来的，在 include/asm/system.h 中 */
